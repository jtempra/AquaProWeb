...
namespace AquaProWeb.Api.Controllers.Configuracio.TaulesGenerals
{
    ...
    {
        [HttpPost("add")]
        public async Task<IActionResult> AddTipusUbicacioAsync([FromBody] SaveTipusUbicacioDTO createTipusUbicacioDTO)
        {
        ...
        [HttpPut("update")]
        public async Task<IActionResult> UpdateTipusUbicacioAsync([FromBody] SaveTipusUbicacioDTO updateTipusUbicacioDTO)
        {
        ...
        [HttpGet("search")]
        public async Task<IActionResult> GetTipusUbicacioByTextAsync(string text)
        {
            var response = await Sender.Send(new GetTipusUbicacioByTextQuery { Text = text });
