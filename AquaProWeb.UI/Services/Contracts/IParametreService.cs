...
namespace AquaProWeb.UI.Services.Contracts
{
	...
	{
		Task<ResponseWrapper<int>> AddParametreAsync(CreateParametreDTO createParametreDTO);
		...
		Task<ResponseWrapper<int>> UpdateParametreAsync(UpdateParametreDTO updateParametreDTO);
	}
