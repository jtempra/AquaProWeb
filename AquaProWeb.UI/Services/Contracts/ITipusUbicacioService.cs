...
{
    Task<ResponseWrapper<int>> AddTipusUbicacioAsync(SaveTipusUbicacioDTO createTipusUbicacioDTO);
    ...
    Task<ResponseWrapper<int>> UpdateTipusUbicacioAsync(SaveTipusUbicacioDTO updateTipusUbicacioDTO);
}