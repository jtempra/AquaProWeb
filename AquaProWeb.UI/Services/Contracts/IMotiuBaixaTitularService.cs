...
{
    Task<ResponseWrapper<int>> AddMotiuBaixaTitularAsync(SaveMotiuBaixaTitularDTO createMotiuBaixaTitularDTO);
    ...
    Task<ResponseWrapper<int>> UpdateMotiuBaixaTitularAsync(SaveMotiuBaixaTitularDTO updateMotiuBaixaTitularDTO);
}