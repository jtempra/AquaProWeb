...
{
    Task<ResponseWrapper<int>> AddTipusOrdreTreballAsync(SaveTipusOrdreTreballDTO createTipusOrdreTreballDTO);
    ...
    Task<ResponseWrapper<int>> UpdateTipusOrdreTreballAsync(SaveTipusOrdreTreballDTO updateTipusOrdreTreballDTO);
}