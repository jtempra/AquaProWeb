...
{
    Task<ResponseWrapper<int>> AddUsContracteAsync(SaveUsContracteDTO createUsContracteDTO);
    ...
    Task<ResponseWrapper<int>> UpdateUsContracteAsync(SaveUsContracteDTO updateUsContracteDTO);
}