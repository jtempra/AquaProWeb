...
{
    Task<ResponseWrapper<int>> AddTipusQueixaAsync(SaveTipusQueixaDTO createTipusQueixaDTO);
    ...
    Task<ResponseWrapper<int>> UpdateTipusQueixaAsync(SaveTipusQueixaDTO updateTipusQueixaDTO);
}