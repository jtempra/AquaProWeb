...
{
    Task<ResponseWrapper<int>> AddTipusFacturaAsync(CreateTipusFacturaDTO createTipusFacturaDTO);
    ...
    Task<ResponseWrapper<int>> UpdateTipusFacturaAsync(UpdateTipusFacturaDTO updateTipusFacturaDTO);
}