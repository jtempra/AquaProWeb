...
{
    Task<ResponseWrapper<int>> AddTipusSuggerimentAsync(SaveTipusSuggerimentDTO createTipusSuggerimentDTO);
    ...
    Task<ResponseWrapper<int>> UpdateTipusSuggerimentAsync(SaveTipusSuggerimentDTO updateTipusSuggerimentDTO);
}