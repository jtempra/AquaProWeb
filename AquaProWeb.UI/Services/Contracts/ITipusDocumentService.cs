...
{
    Task<ResponseWrapper<int>> AddTipusDocumentAsync(CreateTipusDocumentDTO createTipusDocumentDTO);
    ...
    Task<ResponseWrapper<int>> UpdateTipusDocumentAsync(UpdateTipusDocumentDTO updateTipusDocumentDTO);
}