...
{
    Task<ResponseWrapper<int>> AddTipusBaixaClientAsync(CreateTipusBaixaClientDTO createTipusBaixaClientDTO);
    ...
    Task<ResponseWrapper<int>> UpdateTipusBaixaClientAsync(UpdateTipusBaixaClientDTO updateTipusBaixaClientDTO);
}