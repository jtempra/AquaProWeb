...
{
    Task<ResponseWrapper<int>> AddTipusConcepteFacturaAsync(SaveTipusConcepteFacturaDTO createTipusConcepteFacturaDTO);
    ...
    Task<ResponseWrapper<int>> UpdateTipusConcepteFacturaAsync(SaveTipusConcepteFacturaDTO updateTipusConcepteFacturaDTO);
}