...
{
    Task<ResponseWrapper<int>> AddRutaLecturaAsync(SaveRutaLecturaDTO createRutaLecturaDTO);
    ...
    Task<ResponseWrapper<int>> UpdateRutaLecturaAsync(SaveRutaLecturaDTO updateRutaLecturaDTO);
}