...
{
    Task<ResponseWrapper<int>> AddZonaFacturacioAsync(CreateZonaFacturacioDTO createZonaFacturacioDTO);
    ...
    Task<ResponseWrapper<int>> UpdateZonaFacturacioAsync(UpdateZonaFacturacioDTO updateZonaFacturacioDTO);
}