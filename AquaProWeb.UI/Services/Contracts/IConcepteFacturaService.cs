...
{
    Task<ResponseWrapper<int>> AddConcepteFacturaAsync(SaveConcepteFacturaDTO createConcepteFacturaDTO);
    ...
    Task<ResponseWrapper<int>> UpdateConcepteFacturaAsync(SaveConcepteFacturaDTO updateConcepteFacturaDTO);
}