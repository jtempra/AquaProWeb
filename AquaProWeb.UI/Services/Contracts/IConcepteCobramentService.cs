...
{
    Task<ResponseWrapper<int>> AddConcepteCobramentAsync(SaveConcepteCobramentDTO createConcepteCobramentDTO);
    ...
    Task<ResponseWrapper<int>> UpdateConcepteCobramentAsync(SaveConcepteCobramentDTO updateConcepteCobramentDTO);
}