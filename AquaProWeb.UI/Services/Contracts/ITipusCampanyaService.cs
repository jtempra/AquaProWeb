...
{
    Task<ResponseWrapper<int>> AddTipusCampanyaAsync(SaveTipusCampanyaDTO createTipusCampanyaDTO);
    ...
    Task<ResponseWrapper<int>> UpdateTipusCampanyaAsync(SaveTipusCampanyaDTO updateTipusCampanyaDTO);
}