...
{
    public class GetCarrerByTextQuery : IRequest<ResponseWrapper<List<ReadCarrerDTO>>>
    {
        public string Text { get; set; }
    }

    public class GetCarrerByTextQueryHandler : IRequestHandler<GetCarrerByTextQuery, ResponseWrapper<List<ReadCarrerDTO>>>
    {
        ...
        public async Task<ResponseWrapper<List<ReadCarrerDTO>>> Handle(GetCarrerByTextQuery request, CancellationToken cancellationToken)
        {
